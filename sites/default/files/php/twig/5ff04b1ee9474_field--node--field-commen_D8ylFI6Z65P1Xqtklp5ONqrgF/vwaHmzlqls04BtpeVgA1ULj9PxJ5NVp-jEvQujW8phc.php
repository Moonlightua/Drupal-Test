...
class __TwigTemplate_466c4e2584f69e402db82c2ba1d7128df392f47c82afa25e4beea64cd34a6577 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["set" => 1, "if" => 8];
        $filters = ["clean_class" => 1, "replace" => 1, "escape" => 7, "t" => 10, "without" => 22];
        $functions = [];

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if'],
                ['clean_class', 'replace', 'escape', 't', 'without'],
                []
            );
...
<section";
  ...
  ";
      ...
      <h2";
            ...
            echo "><span>";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar("Add new comment");
            echo "</span></h2>
      ";
            // line 22
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->withoutFilter($this->sandbox->ensureToStringAllowed(($context["comment_form"] ?? null)), "label"), "html", null, true);
            echo "
    </div>
  ";
        }
...
";
    ...
    {
        return array (  125 => 25,  119 => 22,  113 => 21,  108 => 20,  106 => 19,  100 => 16,  94 => 15,  90 => 14,  87 => 13,  82 => 11,  76 => 10,  71 => 9,  69 => 8,  65 => 7,  62 => 6,  60 => 4,  59 => 3,  57 => 2,  55 => 1,);
    }
